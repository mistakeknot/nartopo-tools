...
The CLI validates the schema using Zod, calculates the file slug, templates the Markdown headers correctly, writes the file, and validates the output can be parsed back. On success it prints the relative path (`data/{slug}.md`).
